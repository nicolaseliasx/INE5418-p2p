...
class Peer_Node:
    ...
    def peer_node(node_id, config, topology, metadata):
        ...
        ttl = metadata['ttl']
        node_request = metadata['node_request']

        chunks_available = {}  # {'file_name': {chunk_id: [peer_ips]}}
                ...
                try:
                    ...
                    if message['type'] == 'search':
                        ...
                        if available_chunks:
                            ...
                            if debug: print(f"DEBUG: Peer {node_id} enviando resposta com chunks {available_chunks} para Peer {node_request}")
                    ...
                    # Trata a resposta somente se for o peer solicitante
                        ...
                        # Log de acompanhamento do progresso de chunks encontrados
                        chunks_found = set(chunks_available[file_name].keys())
                        if debug: print(f"DEBUG: Chunks encontrados até agora para '{file_name}': {chunks_found}. Ainda faltam: {required_chunks - chunks_found}")
        ...
        def concatenate_chunks(file_name, total_chunks, node_id):
            ...
            with open(final_path, 'wb') as final_file:
                for chunk_id in range(total_chunks):
                    # Ajusta o caminho do chunk para incluir o diretório do node_id
        ...
        def request_chunks_sequentially(file_name, total_chunks):
            """
            Solicita os chunks de uma vez após garantir que todos foram localizados.
            """
        ...
        # Mensagem inicial de busca, alterado o arquivo de metadados para ter mais uma linnha informando qual nodo solicitou
